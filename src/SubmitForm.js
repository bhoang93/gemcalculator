...
const SubmitForm = ({ setStartDate, setCurrentGems, setEndDate, onSubmit, advanced, onSubmitAdvanced, setDaysLoggedIn, setStoryGems, setAdvDates, advancedDates, newStoryCheck, tmGemsCheck, allProjections }) => {
...
const importantDates = (setEndDate) => {
	...
	<div className="projections br3 ba b--black-10 mv4 w-50-m w-25-l shadow-5 center">
		...
		<p>Everything <input type="checkbox" id="allCheck" onChange={allProjections}></input> </p>
		<span>Future Story Islands <input type="checkbox" id="proj1" onChange={newStoryCheck}></input>
		Treasure Map Mode <input type="checkbox" id="proj2" onChange={tmGemsCheck}></input></span>
	</div>
